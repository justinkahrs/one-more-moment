...
<div className="grid items-center gap-8 md:grid-cols-2">
  <div>
    ## Our Mission Our mission is to bring comfort, dignity, and hope to
  ...
  <div>![Group Photo](../assets/about-page.jpg)</div>
</div>
...
<div className="mt-12 space-y-12">
  <div className="grid items-center gap-8 md:grid-cols-2">
    ...
    <div>
      ### Jason Pohlonski After losing his mother to cancer in September of
  ...
  <div className="grid items-center gap-8 md:grid-cols-2">
    <div className="order-2 md:order-1">
      ### Simone Goga Since arriving in the United State from Eastern Europe in
  ...
  <div className="grid items-center gap-8 md:grid-cols-2">
    ...
    <div>
      ### Carrie House Carrie brings a wealth of experience and compassion to
  ...
  <div className="grid items-center gap-8 md:grid-cols-2">
    <div className="order-2 md:order-1">
      ### Andy Thompson Andy Thompson earned his Bachelor’s Degree in
